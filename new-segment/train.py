...
def main():
    ...
    train_gen = batch_gen(train_set, BATCH_SIZE, AUG_FLAG, TRAIN_AUG, CLASS_NAMES, INPUT_SHAPE, N_EPOCHS, False)
    val_gen = batch_gen(val_set, BATCH_SIZE, False, VAL_AUG, CLASS_NAMES, INPUT_SHAPE, N_EPOCHS, False)
